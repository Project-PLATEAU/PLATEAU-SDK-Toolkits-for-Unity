...
- [2. トラック移動コンポーネント](#2-トラック移動コンポーネント)
  - [2-1. トラック上の正規化位置](#2-1-トラック上の正規化位置)
  - [2-2. トラック移動コンポーネントの設定方法](#2-2-トラック移動コンポーネントの設定方法)
  - [2-3. トラック移動コンポーネントの利用方法](#2-3-トラック移動コンポーネントの利用方法)
  - [2-4. トラック移動コンポーネントの機能](#2-4-トラック移動コンポーネントの機能)
