    ...
    public partial class MeshDraft
    {
        ...
        public static MeshDraft Prism(float radius, int segments, float height, bool generateUV = true)
        {
            ...
            var draft = new MeshDraft {name = "Prism"}
                .AddFlatQuadBand(lowerRing, upperRing, Vector2.zero, generateUV);
        ...
        /// Constructs a partial box with specified faces
        /// </summary>
        public static MeshDraft PartialBox(Vector3 origin, Vector3 width, Vector3 depth, Vector3 height, Vector2 uvScale, Directions parts)
        {
            Vector3 v000 = -width/2 - depth/2 - height/2;
            Vector3 v001 = v000 + height;
            Vector3 v010 = v000 + width;
            ...
            if (parts.HasFlag(Directions.Left))
            {
                ...
                draft.AddQuad(v100, v101, v001, v000, calculateNormal:true, uv0, uv1, uv2, uv3);
            }
