...
| 更新日時       | リリース                                                                                                                                                                                                                           | 更新内容                                                                                                                                                                                                               |
|:-----------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026/03/12 | **8th Release** <br>Toolkitの各種機能を動的タイルに対応| PLATEAU SDK for Unityのアップデートに伴う更新
| 2025/03/04 | **7th Release** | PLATEAU SDK for Unityのアップデートに伴う更新
| 2025/01/30 | **6th Release** <br>Sandbox Toolkitに以下の機能を追加 <br>1. 交通シミュレーション機能<br>2. 電柱の結線機能<br>3. 建築物アセットにホテル、工場、複合ビルを追加                                                                                                                    | Sandbox Toolkit v2.2.0（ベータ版）                                                                                                                                                                                       |
